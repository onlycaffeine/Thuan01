...
class Thuan_01():
    ...
    def main(self):
        ...
        parser.add_option("-l", dest="link", type='string', help="Specifies the url")
        parser.add_option("-d", dest="data", type='string', help="Specifies the data")
        parser.add_option("-f", dest="fail", type='string', help="Specifies the fail login message")
        ...
        parser.add_option("-t", dest="token", type='string', help="Specifies the token")
